...
import * as usePerformanceOptimizationModule from "../usePerformanceOptimization";
...
const { usePerformanceOptimization } = usePerformanceOptimizationModule;
...
describe("UsePerformanceOptimization", () => {
  ...
  it("should import without crashing", () => {
    expect(() => {
      expect(usePerformanceOptimizationModule).toBeDefined();
    }).not.toThrow();
  });
  ...
  it("should handle errors gracefully", () => {
    expect(() => {
      expect(typeof usePerformanceOptimizationModule).toBe("object");
    }).not.toThrow();
  });
});
