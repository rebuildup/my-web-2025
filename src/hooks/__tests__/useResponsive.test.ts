...
import * as useResponsiveModule from "../useResponsive";
...
const { useResponsive } = useResponsiveModule;
...
describe("UseResponsive", () => {
  ...
  it("should import without crashing", () => {
    expect(() => {
      expect(useResponsiveModule).toBeDefined();
    }).not.toThrow();
  });
  ...
  it("should handle errors gracefully", () => {
    expect(() => {
      expect(typeof useResponsiveModule).toBe("object");
    }).not.toThrow();
  });
});
