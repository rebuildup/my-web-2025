...
import * as useOfflinePerformanceModule from "../useOfflinePerformance";
...
const { useOfflinePerformance } = useOfflinePerformanceModule;

describe("UseOfflinePerformance", () => {
  beforeEach(() => {
    jest.clearAllMocks();
  ...
  it("should import without crashing", () => {
    expect(() => {
      expect(useOfflinePerformanceModule).toBeDefined();
    }).not.toThrow();
  });
  ...
  it("should return expected structure", () => {
    const { result } = renderHook(() =>
      useOfflinePerformance({ toolName: "test" }),
    );
  ...
  it("should handle errors gracefully", () => {
    expect(() => {
      expect(typeof useOfflinePerformanceModule).toBe("object");
    }).not.toThrow();
  });
});
