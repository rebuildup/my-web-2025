		...
		<div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 overflow-hidden">
			<div className="flex items-center space-x-2 sm:space-x-4 min-w-0 flex-1">
				...
				<button
					...
					className="flex items-center justify-center px-2 sm:px-3 py-2 border hover:border-accent hover:text-accent transition-colors"
			...
			{/* Sort Description */}
			<div className="hidden sm:block text-xs sm:text-sm shrink-0">
