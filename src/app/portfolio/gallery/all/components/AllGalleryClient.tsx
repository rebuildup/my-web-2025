...
export function AllGalleryClient({
  ...
  console.log("AllGalleryClient rendered with:", {
  ...
  // State management
  const [selectedItem, setSelectedItem] = useState<EnhancedContentItem | null>(
    null,
  );
  ...
  const handleCardClick = useCallback((item: EnhancedContentItem) => {
          ...
          <div className="space-y-4">
            ...
            <div className="flex items-center space-x-4 text-sm">
              <span className="text-accent">
                {filteredAndSortedItems.length} / {initialItems.length} projects
              </span>
