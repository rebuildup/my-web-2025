...
export default function VideoDetailPanel({
	...
	return (
		...
		>
			<div
				className="bg-base border border-main max-w-4xl w-full max-h-[90vh] overflow-y-auto backdrop-blur-sm"
			...
			>
				...
				<div className="flex items-center justify-between p-4 border-b border-main">
					...
					<button
						type="button"
						onClick={onClose}
						className="p-2 hover:bg-base transition-colors focus:outline-none focus:ring-2 focus:ring-main"
				...
				<div className="p-6 space-y-6">
							...
							<div className="flex flex-wrap gap-4">
								{item.externalLinks.map((link, index) => (
									<a
										...
										className="flex items-center gap-2 text-accent hover:text-main transition-colors"
									>
					...
					<div className="flex justify-between pt-4 border-t border-main">
						<Link
							...
							className="bg-main text-base px-4 py-2 hover:bg-accent transition-colors focus:outline-none focus:ring-2 focus:ring-main"
						>
							<span className="noto-sans-jp-light text-sm">
								詳細ページを見る
							</span>
						...
						{youtubeVideo && (
							<a
								...
								target="_blank"
								rel="noopener noreferrer"
								className="border border-main px-4 py-2 hover:border-accent hover:text-accent transition-colors focus:outline-none focus:ring-2 focus:ring-main"
							>
								<span className="noto-sans-jp-light text-sm">
									YouTubeで見る
								</span>
