							...
							<section>
								...
								<div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
									{videoItems.map((item: ContentItem) => (
										<div
											key={item.id}
											className="bg-base border border-main p-6 space-y-6"
										>
											{/* Project Video/Image */}
											<div className="relative aspect-video bg-base border border-main overflow-hidden">
												{item.videos && item.videos.length > 0 ? (
											...
											<div className="space-y-4">
												...
												{/* Production Details */}
												<div>
													<h4 className="zen-kaku-gothic-new text-sm text-main mb-2">
														Production Tools
													</h4>
															...
															{item.videos?.map((video, index) => (
																...
																>
																	...
																	<a
																		...
																		className="noto-sans-jp-light text-xs text-accent border border-accent px-2 py-1 hover:bg-accent hover:text-main transition-colors"
																	>
																		Watch
																	</a>
																</div>
												...
												<div className="flex space-x-4">
													<Link
														...
														className="noto-sans-jp-light text-sm text-accent border border-accent px-3 py-1 hover:bg-accent hover:text-main transition-colors"
													>
														View Details
													</Link>
													{item.externalLinks?.find(
														...
														<a
															...
															target="_blank"
															rel="noopener noreferrer"
															className="noto-sans-jp-light text-sm text-main border border-main px-3 py-1 hover:border-accent hover:text-accent transition-colors"
														>
															Watch Online
														</a>
													)}
