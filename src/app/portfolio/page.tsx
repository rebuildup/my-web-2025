...
const galleryCategories: GalleryCategory[] = [
  {
    ...
    title: "All Works",
    description: "全作品一覧",
    detailedDescription: "バラエティを重視した全作品の一覧。時系列ソート、カテゴリフィルター、検索機能を備えたギャラリー",
  ...
  },
  {
    ...
    title: "Development",
    description: "開発系作品",
    detailedDescription: "プログラミング関連の制作物。プラグイン開発、ゲーム制作、Webアプリケーション、技術詳細を重視した表示",
  ...
  },
  {
    ...
    detailedDescription: "映像に加えて画像デザイン、Webデザインなど。デザインスキルを強調したクリエイティブギャラリー",
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              <Link
                ...
                className="group border border-foreground/20 bg-gray/50 overflow-hidden hover:shadow-lg transition-shadow"
              >
                ...
                <div className="p-6">
                  ...
                  <p className="noto-sans-jp text-sm text-foreground/70 mb-3">
                    Modern portfolio website built with React and Next.js featuring responsive design and interactive animations.
                  </p>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="noto-sans-jp text-sm text-foreground/70 mb-3">
                    Creative music video production featuring advanced visual effects and cinematography for emerging artist.
                  </p>
                  <div className="flex flex-wrap gap-1 mb-3">
                    <span className="px-2 py-1 bg-primary/20 text-primary text-xs rounded">After Effects</span>
                    <span className="px-2 py-1 bg-primary/20 text-primary text-xs rounded">Premiere Pro</span>
                  </div>
                  <div className="text-primary text-xs font-medium group-hover:underline">
                    詳細を見る →
                  </div>
              ...
              >
                ...
                <div className="p-6">
                  ...
                  <p className="noto-sans-jp text-sm text-foreground/70 mb-3">
                    Complete brand identity design including logo, color palette, typography, and brand guidelines for tech startup.
                  </p>
                  <div className="flex flex-wrap gap-1 mb-3">
                    <span className="px-2 py-1 bg-primary/20 text-primary text-xs rounded">Brand Design</span>
                    <span className="px-2 py-1 bg-primary/20 text-primary text-xs rounded">Logo Design</span>
                  </div>
                  <div className="text-primary text-xs font-medium group-hover:underline">
                    詳細を見る →
                  </div>
