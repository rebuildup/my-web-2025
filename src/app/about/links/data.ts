...
export const links: LinkItem[] = [
	...
	},
	{
		id: "bluesky",
		title: "BlueSky",
		url: "https://bsky.app/profile/361do.bsky.social",
		icon: MessageCircle,
		description: "361do",
		color: "#0085ff",
	},
	{
		id: "atcoder",
		title: "AtCoder",
		url: "https://atcoder.jp/users/rebuildup",
		icon: Trophy,
		description: "rebuildup",
		color: "#000000",
	},
	{
		id: "wantedly",
		title: "Wantedly",
		url: "https://www.wantedly.com/id/rebuildup",
		icon: Briefcase,
		description: "rebuildup",
		color: "#26C6DA",
	},
	{
		id: "note",
		title: "note",
		url: "https://note.com/alert_toad4443",
		icon: FileText,
		description: "samuido",
		color: "#41C9B4",
	},
	{
		id: "zenn",
		title: "Zenn",
		url: "https://zenn.dev/361do_sleep",
		icon: BookOpen,
		description: "361do_sleep",
		color: "#3EA8FF",
	},
	...
	},
	{
		id: "gitty",
		title: "Gitty",
		url: "https://gitty-code.com/user/rebuildup",
		icon: GitBranch,
		description: "rebuildup",
		color: "#6A9FB5",
	},
