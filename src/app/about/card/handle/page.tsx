                ...
                <div ref={cardRef} className="bg-base border border-accent p-8">
                  ...
                  <div className="border-b border-accent pb-6 mb-6">
                    <div className="flex items-start justify-between">
                      <div>
                        <h2 className="neue-haas-grotesk-display text-3xl text-primary mb-2">
                          {cardData.name}
                        </h2>
                ...
                <div className="bg-base border border-foreground p-4">
                  ...
                  <div className="space-y-3">
                    <button
                      ...
                      className="w-full border border-accent text-center p-4 flex items-center justify-center focus:outline-none focus:ring-2 focus:ring-accent focus:ring-offset-2 focus:ring-offset-background"
                    >
