...
import * as EnhancedFileUploadSectionModule from "../EnhancedFileUploadSection";
...
const EnhancedFileUploadSection =
  ...
  (EnhancedFileUploadSectionModule as any).default ||
  EnhancedFileUploadSectionModule;
...
describe("EnhancedFileUploadSection", () => {
  ...
  it("should import without crashing", () => {
    expect(() => {
      expect(EnhancedFileUploadSectionModule).toBeDefined();
    }).not.toThrow();
  });

  it("should render without crashing", () => {
    expect(() => {
      if (typeof EnhancedFileUploadSection === "function") {
        render(<EnhancedFileUploadSection />);
      }
    }).not.toThrow();
  });
  ...
  it("should handle errors gracefully", () => {
    expect(() => {
      expect(typeof EnhancedFileUploadSectionModule).toBe("object");
    }).not.toThrow();
  });
});
