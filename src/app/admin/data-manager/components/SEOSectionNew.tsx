...
export function SEOSection({
	...
	const handleKeywordsChange = (keywordsString: string) => {
	 ...
	 <h3 className="neue-haas-grotesk-display text-xl leading-snug">SEO Settings</h3>
	 {/* Basic SEO */}
	 <div className="space-y-4">
	 <div>
	 ...
	 {/* Social Media Images */}
	 <div className="space-y-4">
	 <h4 className="noto-sans-jp-regular text-sm font-medium ">Social Media Images</h4>
	 <div>
	 ...
	 {/* Advanced Settings */}
	 <div className="space-y-4">
	 <h4 className="noto-sans-jp-regular text-sm font-medium ">Advanced Settings</h4>
	 <div>
	 ...
	 <h4 className="noto-sans-jp-regular text-sm font-medium mb-3">Search Engine Preview</h4>
	 <div className="space-y-2">
	 ...
	 <div className="border border-gray-200 p-4 rounded">
	 <h4 className="noto-sans-jp-regular text-sm font-medium mb-3">Social Media Preview</h4>
	 ...
	 <h4 className="noto-sans-jp-regular text-sm font-medium mb-3">Dynamic Generated Mockup</h4>
