...
export function SEOSection({
	...
	const handleKeywordsChange = (keywordsString: string) => {
	 ...
	 <div className=" text-sm">https://yusuke-kim.com/example-url</div>
	 <div className=" text-sm">{seo?.description || "Page description will appear here..."}</div>
	 </div>
	 </div>
	 )}
	 ...
	 <div className="p-3 ">
	 <div className="text-sm font-medium  mb-1">{seo?.title || "Page Title"}</div>
	 <div className="text-xs  mb-1">{seo?.description || "Page description will appear here..."}</div>
	 ...
	 <p className="text-xs  mb-2">Based on current title, category, tags, and thumbnail.</p>
	 <div className="  rounded overflow-hidden max-w-md">
	 <div className="aspect-video ">
	 {/* eslint-disable-next-line @next/next/no-img-element */}
	 <img
