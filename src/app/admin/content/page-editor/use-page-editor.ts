...
import { INITIAL_BLOCKS, type ToastMessage } from "./types";
...
export interface UsePageEditorResult {
 ...
 setActiveBlockId: (value: string | null) => void;
 editorId: string;
 page: MarkdownPage | null;
 setPage: (page: MarkdownPage | null) => void;
 blocks: Block[];
 ...
 reset: (page: MarkdownPage, blocks: Block[]) => void;
 toolbarState: {
 isSaving: boolean;
 lastSaved: Date | null;
 hasUnsavedChanges: boolean;
 };
 loadPages: (contentId: string) => Promise<void>;
 loadMedia: (contentId: string) => Promise<void>;
 resetEditor: () => void;
 handleSelectPage: (page: MarkdownPage) => Promise<void>;
 handleManualSave: () => Promise<void>;
 handleCreatePage: () => Promise<void>;
 handleEditMeta: (page: MarkdownPage) => Promise<void>;
 handleDeletePage: (page: MarkdownPage) => Promise<void>;
 handleInsertBlock: (type: BlockType) => void;
}

export function usePageEditor(): UsePageEditorResult {
