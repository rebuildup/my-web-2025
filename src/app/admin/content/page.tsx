...
import { Upload, FileText, Edit, Trash2, Save, X, Plus, Search } from 'lucide-react';
...
export default function AdminContentPage() {
  ...
  const [selectedType, setSelectedType] = useState<
    'all' | 'portfolio' | 'blog' | 'plugin' | 'download'
  >('all');
              ...
              <div className="flex flex-wrap items-center justify-between gap-4">
                <div className="flex items-center gap-4">
                  ...
                  <div className="relative">
                    <Search
                      size={20}
                      className="text-foreground/40 absolute top-1/2 left-3 -translate-y-1/2"
                    />
                    <input
                      type="text"
                      ...
                      className="border-foreground/20 bg-gray/50 text-foreground placeholder:text-foreground/50 focus:ring-primary border py-2 pr-4 pl-10 focus:ring-2 focus:outline-none"
                    />
                  </div>
                  ...
                  <select
                    ...
                    className="border-foreground/20 bg-gray/50 text-foreground focus:ring-primary border px-4 py-2 focus:ring-2 focus:outline-none"
                  >
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <select
                        ...
                        className="border-foreground/20 bg-gray text-foreground focus:ring-primary w-full border px-3 py-2 focus:ring-2 focus:outline-none"
                      >
                    ...
                    <div>
                      ...
                      <input
                        ...
                        className="border-foreground/20 bg-gray text-foreground placeholder:text-foreground/50 focus:ring-primary w-full border px-3 py-2 focus:ring-2 focus:outline-none"
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <textarea
                        ...
                        rows={10}
                        className="border-foreground/20 bg-gray text-foreground placeholder:text-foreground/50 focus:ring-primary w-full border px-3 py-2 font-mono text-sm focus:ring-2 focus:outline-none"
