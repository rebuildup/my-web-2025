...
export default function EngagementMetrics({
  ...
  const CardStyle = "bg-base border border-foreground block p-4 space-y-4";
          ...
          <div className="bg-base border border-foreground p-4">
            <div className="flex flex-wrap gap-3">
              {engagement.engagement.popularTags.slice(0, 10).map((tagData) => (
                <div
                  key={tagData.tag}
                  className="flex items-center space-x-2 bg-background border border-foreground px-3 py-2"
                >
