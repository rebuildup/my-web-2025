...
import { forwardRef, ButtonHTMLAttributes, useEffect, useRef } from "react";
  ...
  (
    ...
    const variantStyles = {
      ...
      secondary: `
        ...
        hover:bg-base
        focus:ring-foreground focus:ring-offset-background
      `,
      danger: `
      ...
      ghost: `
        ...
        hover:bg-base hover:border-foreground
        focus:ring-foreground focus:ring-offset-background
      `,
    };
      ...
      >
        {loading ? (
          ...
          <span className="flex items-center space-x-2">
            ...
            {shortcut && (
              <kbd
                className="text-xs bg-background bg-opacity-20 border border-current px-1.5 py-0.5 rounded"
