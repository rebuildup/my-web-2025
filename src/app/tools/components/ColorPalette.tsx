...
import { Copy, Download, RefreshCw, Palette } from 'lucide-react';
...
const ColorPalette: React.FC = () => {
  ...
  const generateHarmony = useCallback(
    (baseHex: string, type: HarmonyType): ColorData[] => {
  ...
  return (
    <div className="space-y-6">
            ...
            <div key={index} className="border-foreground/20 group border">
              ...
              <div className="p-3">
                ...
                <div className="space-y-1 text-xs">
                  <div className="text-foreground/80 font-mono">{color.hex.toUpperCase()}</div>
                    ...
                    <div className="mt-2 space-y-1">
                      ...
                      {colors.slice(1).map((otherColor, otherIndex) => {
                        ...
                        return (
                          <div
                            key={otherIndex}
                            className={`text-xs ${isGood ? 'text-green-600' : 'text-red-600'}`}
                          >
      ...
      {/* Usage Examples */}
      <div className="border-foreground/20 border p-6">
        <h3 className="neue-haas-grotesk-display text-foreground mb-4 text-xl">Preview</h3>
