...
const AccessibleSelect = forwardRef<HTMLSelectElement, AccessibleSelectProps>(
  (
    ...
    const baseSelectStyles = `
      w-full bg-background border text-foreground
    ...
    return (
      <div className="space-y-2">
        ...
        <label
          htmlFor={selectId}
          className="neue-haas-grotesk-display text-sm text-primary block"
        >
          {label}
        ...
        {helpText && (
          <p
            id={helpTextId}
            className="noto-sans-jp-light text-xs text-foreground opacity-75"
          >
            {helpText}
          </p>
        )}
