...
import * as ColorPaletteGeneratorModule from "../ColorPaletteGenerator";
...
const ColorPaletteGenerator =
  // eslint-disable-next-line @typescript-eslint/no-explicit-any
  (ColorPaletteGeneratorModule as any).default || ColorPaletteGeneratorModule;
...
describe("ColorPaletteGenerator", () => {
  ...
  it("should import without crashing", () => {
    expect(() => {
      expect(ColorPaletteGeneratorModule).toBeDefined();
    }).not.toThrow();
  });

  it("should render without crashing", () => {
    expect(() => {
      if (typeof ColorPaletteGenerator === "function") {
  ...
  it("should handle errors gracefully", () => {
    expect(() => {
      expect(typeof ColorPaletteGeneratorModule).toBe("object");
    }).not.toThrow();
  });
});
