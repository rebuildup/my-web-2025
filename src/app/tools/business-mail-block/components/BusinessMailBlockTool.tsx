...
const BUILT_IN_TEMPLATES: MailTemplate[] = [
  {
    ...
    blocks: [
      {
        ...MAIL_BLOCKS.find((b) => b.id === "greeting-first")!,
        id: "greeting-first-1",
      },
      {
        ...MAIL_BLOCKS.find((b) => b.id === "body-request")!,
        id: "body-request-1",
      },
      {
        ...MAIL_BLOCKS.find((b) => b.id === "closing-reply")!,
        id: "closing-reply-1",
      },
      {
        ...MAIL_BLOCKS.find((b) => b.id === "signature-basic")!,
        id: "signature-basic-1",
      },
    ],
    variables: {
      company: "株式会社サンプル",
  ...
  },
  {
    ...
    blocks: [
      {
        ...MAIL_BLOCKS.find((b) => b.id === "greeting-regular")!,
        id: "greeting-regular-1",
      },
      {
        ...MAIL_BLOCKS.find((b) => b.id === "body-thanks")!,
        id: "body-thanks-1",
      },
      {
        ...MAIL_BLOCKS.find((b) => b.id === "body-confirm")!,
        id: "body-confirm-1",
      },
      {
        ...MAIL_BLOCKS.find((b) => b.id === "closing-contact")!,
        id: "closing-contact-1",
      },
      {
        ...MAIL_BLOCKS.find((b) => b.id === "signature-basic")!,
        id: "signature-basic-1",
  ...
  },
  {
    ...
    blocks: [
      {
        ...MAIL_BLOCKS.find((b) => b.id === "greeting-urgent")!,
        id: "greeting-urgent-1",
      },
      {
        ...MAIL_BLOCKS.find((b) => b.id === "body-apology")!,
        id: "body-apology-1",
      },
      {
        ...MAIL_BLOCKS.find((b) => b.id === "closing-cooperation")!,
    ...
    >
      <DragDropContext onDragEnd={handleDragEnd}>
        <div className="space-y-8">
          {/* Template Library */}
          {showTemplateLibrary && (
            <div className="space-y-4 bg-base border border-foreground p-4">
              ...
              <div className="grid-system grid-1 sm:grid-2 lg:grid-3 gap-4">
                {templates.map((template) => (
                  <div
                    key={template.id}
                    className={`border border-foreground p-3 hover:bg-accent hover:text-background transition-colors ${
                    ...
                    <div className="space-y-2">
                      ...
                      <div className="flex flex-wrap gap-1">
                        {template.blocks.map((block, index) => (
                          <span
                            key={index}
                            className="text-xs px-2 py-1 bg-background border border-foreground"
                          >
                      ...
                      <div className="flex gap-2 pt-2">
                        <button
                          ...
                          className="text-xs px-3 py-1 border border-foreground hover:bg-foreground hover:text-background focus:outline-none focus:ring-2 focus:ring-accent"
                        >
                          読み込み
                        </button>
                        <button
              ...
              <div className="grid-system grid-1 sm:grid-3 gap-6">
                <div className="space-y-3">
                  ...
                  <ul className="space-y-1">
                    {EMAIL_GUIDELINES.structure.map((item, index) => (
                      <li
                        key={index}
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-1">
                    {EMAIL_GUIDELINES.tone.map((item, index) => (
                      <li
                        key={index}
                        className="text-sm noto-sans-jp-light flex items-start gap-2"
                      >
                ...
                <div className="space-y-3">
                  ...
                  <ul className="space-y-1">
                    {EMAIL_GUIDELINES.formatting.map((item, index) => (
                      <li
                        key={index}
                        className="text-sm noto-sans-jp-light flex items-start gap-2"
                      >
            ...
            <div className="space-y-4">
              ...
              <div className="flex flex-wrap gap-2">
                <button
                  ...
                  className={`px-3 py-2 text-sm border border-foreground flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-accent noto-sans-jp-light ${
                    showTemplateLibrary
                      ? "bg-accent text-background"
                ...
                <div className="bg-base border border-foreground p-4 space-y-3">
                  ...
                  <div className="grid-system grid-1 sm:grid-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <textarea
                        ...
                        className="w-full px-3 py-2 border border-foreground bg-background text-foreground focus:outline-none focus:ring-2 focus:ring-accent resize-none"
                        rows={3}
                      />
                    </div>
                  </div>
                  <div className="flex gap-2">
                    <button
                      ...
                      className="px-4 py-2 border border-foreground bg-background text-foreground hover:bg-accent hover:text-background disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-accent noto-sans-jp-regular"
                    >
                      追加
                    </button>
                    <button
                      onClick={() => setShowCustomBlockForm(false)}
                      className="px-4 py-2 border border-foreground bg-background text-foreground hover:bg-accent hover:text-background focus:outline-none focus:ring-2 focus:ring-accent noto-sans-jp-regular"
                    >
                      キャンセル
                    </button>
                  </div>
                            ...
                            <div className="flex items-start justify-between">
                              ...
                              <div className="flex flex-col gap-1 ml-2">
                                <button
                                  ...
                                  className="p-1 hover:bg-accent hover:text-background border border-foreground focus:outline-none focus:ring-2 focus:ring-accent"
                                >
                                  <Heart
                                    className={`w-4 h-4 ${
