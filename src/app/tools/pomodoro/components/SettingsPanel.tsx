  ...
  return (
    <div className="bg-base border border-foreground p-6 rounded-lg">
      <div className="flex items-center justify-between mb-6">
        <h3 className="text-lg font-semibold text-primary">タイマー設定</h3>
        <button
          onClick={onClose}
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <h4 className="font-medium text-primary">時間設定</h4>
          ...
          <div className="grid grid-2 gap-4">
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateSetting("workDuration", parseInt(e.target.value))
                }
                className="w-full"
              />
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateSetting("shortBreakDuration", parseInt(e.target.value))
                }
                className="w-full"
              />
              <div className="flex justify-between text-xs text-foreground mt-1">
            ...
            <div>
              ...
              <input
                ...
                onChange={(e) =>
                  updateSetting("longBreakDuration", parseInt(e.target.value))
                }
                className="w-full"
              />
              <div className="flex justify-between text-xs text-foreground mt-1">
        ...
        {/* Auto-start Settings */}
        <div className="space-y-4">
          <h4 className="font-medium text-primary">自動開始設定</h4>
        ...
        <div className="space-y-4">
          <h4 className="font-medium text-primary">通知設定</h4>
        ...
        {/* Theme Settings */}
        <div className="space-y-4">
          <h4 className="font-medium text-primary">表示設定</h4>
        ...
        <div className="pt-4 border-t border-foreground/20">
          <button
            ...
            className="w-full px-4 py-2 border border-foreground rounded hover:bg-foreground/10 transition-colors text-sm"
          >
            設定をリセット
          </button>
        </div>
