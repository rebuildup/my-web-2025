...
export default function PomodoroTimer() {
  ...
  return (
    <div className="space-y-8">
      {/* Timer Display */}
      <div className="bg-base border border-foreground p-8 rounded-lg text-center">
        <div className="space-y-6">
          ...
          <div className="flex justify-center items-center gap-4">
            ...
            <button
              onClick={handleStop}
              className="flex items-center gap-2 px-4 py-3 border border-foreground rounded-lg hover:bg-foreground/10 transition-colors"
              aria-label="タイマー停止"
            >
              <Square size={20} />
              停止
      ...
      <div className="flex justify-center gap-4">
        <button
          ...
          className="flex items-center gap-2 px-4 py-2 border border-foreground rounded-lg hover:bg-foreground/10 transition-colors"
          aria-label="設定"
        >
          <Settings size={20} />
          設定
