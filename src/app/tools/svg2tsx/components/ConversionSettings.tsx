    ...
    <div className="bg-base border border-foreground p-4">
      ...
      <div className="space-y-6">
        ...
        <div className="space-y-4">
          <h4 className="font-medium text-sm text-foreground/80">基本設定</h4>
        ...
        <div className="space-y-4">
          <h4 className="font-medium text-sm text-foreground/80">最適化設定</h4>
        ...
        {/* Output Settings */}
        <div className="space-y-4">
          <h4 className="font-medium text-sm text-foreground/80">出力設定</h4>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <select
                ...
                onChange={(e) =>
                  updateSetting("indentSize", parseInt(e.target.value))
                }
                className="w-full p-2 border border-foreground bg-background text-sm focus:outline-none focus:ring-2 focus:ring-primary"
              >
