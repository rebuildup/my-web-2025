...
export default function GameDisplay({
  ...
  return (
    <div className="space-y-6">
      {/* Score and Status */}
      <div className="bg-base border border-foreground p-6 text-center">
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <div className="neue-haas-grotesk-display text-3xl text-primary">
              {gameState.score}
            </div>
      ...
      <div className="bg-base border border-foreground p-6">
        <div className="text-center space-y-4">
          ...
          <div className="font-mono text-lg leading-relaxed break-all">
            ...
            <span className="bg-primary text-background px-1 font-bold">
              {piContext.current}
            </span>
          ...
          {showCorrectAnswer && (
            <div className="text-center bg-accent text-background p-4">
          ...
          {gameState.isGameOver && (
            <div className="bg-accent text-background p-4 text-center">
