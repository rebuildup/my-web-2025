        ...
        <div className="space-y-4">
          ...
          <div className="flex flex-wrap gap-4 items-center">
            ...
            <button
              ...
              className="px-4 py-2 border border-foreground bg-background text-foreground hover:bg-accent hover:text-background focus:outline-none focus:ring-2 focus:ring-accent flex items-center gap-2 noto-sans-jp-light"
            >
          ...
          {showAdvancedSettings && (
            <div className="border border-foreground p-4 bg-base space-y-4">
              ...
              <div className="grid-system grid-1 md:grid-2 gap-4">
                <div className="space-y-2">
                  <label className="text-sm noto-sans-jp-regular">
                    エクスポート形式
                  </label>
                  <select
                    value={exportFormat}
                ...
                <div className="space-y-2">
                  ...
                  <div className="flex gap-2">
                    <button
                      ...
                      className={`px-3 py-2 border border-foreground flex items-center gap-2 focus:outline-none focus:ring-2 focus:ring-accent noto-sans-jp-light ${
                        showDocumentation
                          ? "bg-accent text-background"
                          : "bg-background text-foreground"
                      }`}
              ...
              {savedExpressions.length > 0 && (
                <div className="space-y-2">
                  ...
                  <div className="max-h-32 overflow-y-auto border border-foreground p-2 space-y-1">
                    {savedExpressions.map((saved) => (
                      <div
                        key={saved.id}
                        className="flex items-center justify-between p-2 bg-background border border-foreground"
                      >
                ...
                >
                  <div className="flex items-start justify-between mb-2">
                    ...
                    <button
                      ...
                      className="ml-2 p-1 hover:bg-background hover:text-foreground rounded"
                    >
                      <Heart
            ...
            {selectedExpression ? (
              <div className="space-y-4 border border-foreground p-4">
                  ...
                  <div className="flex items-center justify-between mb-2">
                    ...
                    <div className="flex gap-2">
                      <button
                        ...
                        className="p-2 border border-foreground bg-background text-foreground hover:bg-accent hover:text-background focus:outline-none focus:ring-2 focus:ring-accent"
                      >
                        <Heart
                ...
                {showDocumentation && selectedExpression.documentation && (
                  <div className="border border-foreground p-4 bg-base mb-4">
                    <h4 className="text-sm noto-sans-jp-regular font-medium mb-2 flex items-center gap-2">
                      <BookOpen className="w-4 h-4" />
                      詳細ドキュメント
                    </h4>
                    <p className="text-sm noto-sans-jp-light leading-relaxed text-foreground">
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <button
                  ...
                  className="px-3 py-2 border border-foreground bg-background text-foreground hover:bg-accent hover:text-background disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-accent flex items-center gap-2 noto-sans-jp-light"
                >
                ...
                <button
                  ...
                  disabled={!generatedCode}
                  className={`px-4 py-2 border border-foreground hover:bg-accent hover:text-background disabled:opacity-50 disabled:cursor-not-allowed focus:outline-none focus:ring-2 focus:ring-accent flex items-center gap-2 noto-sans-jp-regular ${
                    copySuccess
