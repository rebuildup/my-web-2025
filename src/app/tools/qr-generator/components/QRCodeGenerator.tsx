...
export default function QRCodeGenerator() {
  ...
  }, [inputText, inputType, generateQR]);
      ...
      <div className="space-y-8">
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  <input
                    ...
                    className="w-12 h-8 border border-foreground cursor-pointer"
                  ...
                  <input
                    ...
                    value={foregroundColor}
                    onChange={(e) => setForegroundColor(e.target.value)}
                    className="flex-1 bg-background border border-foreground p-2 text-foreground focus:outline-none focus:ring-2 focus:ring-accent"
                    placeholder="#000000"
        ...
        <section className={CardStyle}>
          ...
          <div className="space-y-4">
            <div className="grid-system grid-1 sm:grid-2 gap-6">
              <div>
                <h4 className="neue-haas-grotesk-display text-lg text-primary mb-2">
                  Features
                </h4>
