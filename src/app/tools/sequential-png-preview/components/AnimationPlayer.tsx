...
import { FrameData, AnimationSettings } from "../types";
...
export default function AnimationPlayer({
  ...
  return (
    <div className="space-y-4">
      ...
      <div
        ref={containerRef}
        className="relative bg-background border border-foreground/20 rounded overflow-hidden"
      >
        <canvas
          ref={canvasRef}
        ...
        <div className="relative">
          ...
          <div className="absolute top-0 left-0 w-full h-2 pointer-events-none">
            {frames.map((_, index) => (
              <div
                key={index}
                className="absolute top-0 w-0.5 h-2 bg-foreground/30"
