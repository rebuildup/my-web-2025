...
.block-image .image-controls:focus-within { opacity: 1; pointer-events: auto; }

.block-video:hover .video-controls,
.block-video .video-controls:focus-within { opacity: 1; pointer-events: auto; }

.block-audio:hover .audio-controls,
.block-audio .audio-controls:focus-within { opacity: 1; pointer-events: auto; }
...
.block-file .file-controls:focus-within { opacity: 1; pointer-events: auto; }
...
.block-gallery .gallery-controls:focus-within { opacity: 1; pointer-events: auto; }
.block-gallery:hover,
.block-gallery:has(.gallery-controls:focus-within) { padding-bottom: 112px; }

.block-spacer:hover .spacer-controls,
.block-spacer .spacer-controls:focus-within { opacity: 1; pointer-events: auto; }

.block-code:hover .codeblock-controls,
.block-code .codeblock-controls:focus-within { opacity: 1; pointer-events: auto; }

.block-custom-html:hover .custom-html-controls,
.block-custom-html .custom-html-controls:focus-within { opacity: 1; pointer-events: auto; }
`;
