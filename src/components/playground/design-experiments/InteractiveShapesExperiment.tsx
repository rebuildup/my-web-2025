...
export const InteractiveShapesExperiment: React.FC<ExperimentProps> = ({
  ...
  }, [mousePosition, config, isMouseDown, draggedShape]);
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-base border border-foreground p-4 space-y-4">
        <div
          className="relative bg-background border border-foreground overflow-hidden cursor-crosshair"
