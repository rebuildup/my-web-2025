...
export const ExperimentLoading = () => (
	<div className="aspect-video bg-base border border-main flex items-center justify-center">
		<div className="text-center space-y-2">
			...
			<p className="text-sm text-main">Loading experiment...</p>
		</div>
	</div>
);
...
export const WebGLLoading = () => (
	<div className="aspect-video bg-base border border-main flex items-center justify-center">
		<div className="text-center space-y-2">
			...
			<p className="text-sm text-main">Initializing WebGL...</p>
			<p className="text-xs text-main/70">Loading shaders and textures</p>
		</div>
	</div>
);
