...
> = ({ experiment, isActive, children, onToggle, onReset, className = "" }) => {
  ...
  const getControlButtonClasses = (
    ...
    if (variant === "primary") {
      return `${baseClasses} bg-accent text-background hover:bg-accent-dark focus:ring-accent`;
    }

    return `${baseClasses} border border-foreground text-foreground hover:bg-foreground hover:text-background focus:ring-foreground`;
  };
  ...
  return (
    ...
    >
      ...
      <div className="flex items-center justify-between mb-4">
        <div>
          ...
          <p
            ...
            className="noto-sans-jp-light text-sm text-foreground mt-1"
          >
      ...
      {accessibilityState.keyboardNavigation && isActive && (
        <div className="mb-4 p-3 bg-base border border-foreground rounded">
