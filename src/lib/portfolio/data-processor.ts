...
import type { PortfolioContentItem, PortfolioStats } from "@/types/portfolio";
  ...
  * Create minimal valid items as last resort
   */
	...
	formatDateForDisplay(
		...
		return portfolioDateManager.formatDateForDisplay(date);
	}
...
const _enhancedPortfolioDataProcessor = new EnhancedPortfolioDataProcessor();
