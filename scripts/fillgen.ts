 ...
 *       bun scripts/fillgen.ts input.txt --html public/generated-quiz.html --react src/components/GeneratedQuiz.tsx
 *
 * プレビュー:
...
if (argv.length === 0 || argv.includes("--help")) {
	console.log(
		[
			"Usage: bun scripts/fillgen.ts <input.txt> [--html out.html] [--react out.tsx] [--preview]",
			"",
